...
# Zip Manager
This Maven project module, written in Java, can be used for managing zip files. In particular, it is possible to decode a zip content either from a file or from a stream.
